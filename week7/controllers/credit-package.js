...
const getCreditPackages = handleErrorAsync(async (_, res) => {
...
const updateUserPurchaseCreditPackage = handleErrorAsync(async (req, res, next) => {
...
module.exports = {
  ...
  createCreditPackage,
  deleteCreditPackage,
  updateUserPurchaseCreditPackage,
};
