const { isInt, isUUID, isEmail, isStrongPassword, isURL, matches } = require('validator');
const dayjs = require('dayjs');

const isNotValidString = (value) => typeof value !== 'string' || value.trim() === '';

const isNotValidInteger = (
  value,
  options = {
    gt: 0,
  }
...
const isNotValidImageURL = (value, options) => isNotValidURL(value, options) || !matches(value, /\.(jpg|png)$/);
